...
class Generator(torch.nn.Module):
    def __init__(self,
        ...
        **synthesis_kwargs,         # Arguments for SynthesisNetwork.
        ...
        self.linear = FullyConnectedLayer(z_dim, synthesis_kwargs['channel_max'], bias=False, activation='linear', lr_multiplier=1)
...
class Discriminator(torch.nn.Module):
    def __init__(self,
        ...
        if c_dim > 0:
            self.mapping = FullyConnectedLayer(c_dim, cmap_dim, bias=False, activation='linear', lr_multiplier=1)
